...
aws ec2 describe-images --region us-east-1 --owners amazon --filters "Name=architecture,Values=x86_64" --filters "Name=owner-alias,Values=amazon" --filters "Name=virtualization-type,Values=hvm" --filters "Name=name,Values=al2023-ami-2023*" --query "sort_by(Images, &CreationDate)[-1].[ImageId]" --output text